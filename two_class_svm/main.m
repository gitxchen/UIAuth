...
log_file='ens_svm_two_class_ui.log';
...
for threshold=0:max_threshold
  ...
  for test_set=1:5
    ...
    for user1=1:n_classes
      false_rej=0;
      false_acc=0;
      button_result = pred_two_class_ui_svm(user1,'button','11110000001', ...
                                          test_set,threshold,n_classes);
  
      checkbox_result = pred_two_class_ui_svm(user1,'checkbox','11110000001', ...
                                            test_set,threshold,n_classes);
  
      radiobutton_result = pred_two_class_ui_svm(user1,'radiobutton','11100000001', ...
                                               test_set,threshold,n_classes);
  
      togglebutton_result = pred_two_class_ui_svm(user1,'togglebutton','11100000001', ...
                                                test_set,threshold,n_classes);
  
      switch_result = pred_two_class_ui_svm(user1,'switch','11110100001', ...
                                          test_set,threshold,n_classes);
  
      edittext_result = pred_two_class_ui_svm(user1,'edittext','10100000001', ...
                                            test_set,threshold,n_classes);
      
      spinner_result = pred_two_class_ui_svm(user1,'spinner','10100000001', ...
                                           test_set,threshold,n_classes);
   
      spinner_button_result = pred_two_class_ui_svm(user1,'spinner-button', ...
                                                  '11110000001', ...
                                                  test_set,threshold,n_classes);
      
      picker_result = pred_two_class_ui_svm(user1,'picker','11110000011', ...
                                          test_set,threshold,n_classes); 
