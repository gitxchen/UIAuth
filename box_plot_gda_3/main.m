...
for test_set=1:5
  ...
  button_result = input_cr_val_test('button','gda',button_k,test_set,fs(1,:),n_classes);
  checkbox_result = input_cr_val_test('checkbox','gda',checkbox_k,test_set,fs(2,:),n_classes);
  radiobutton_result = input_cr_val_test('radiobutton','gda',radiobutton_k,test_set,fs(3,:),n_classes);
  %togglebutton_result = input_cr_val_test('togglebutton','gda',togglebutton_k,test_set,fs(4,:),n_classes);
  switch_result = input_cr_val_test('switch','gda',switch_k,test_set,fs(5,:),n_classes);
  edittext_result = input_cr_val_test('edittext','gda',edittext_k,test_set,fs(6,:),n_classes);
  spinner_result = input_cr_val_test('spinner','gda',spinner_k,test_set,fs(7,:),n_classes);
  spinner_button_result = input_cr_val_test('spinner-button','gda',spinner_button_k,test_set,fs(8,:),n_classes);
  picker_result = input_cr_val_test('picker','gda',picker_k,test_set,fs(9,:),n_classes);
 

  final_result = [button_result checkbox_result radiobutton_result ...
                    switch_result edittext_result spinner_result ...
